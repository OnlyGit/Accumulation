...
//		BufferedReader reader = IOUtil.getReader("search/c/nginx.txt", "UTF-8");
//		String temp = null;
...
//		String text = sb.toString();
		...
		IndexWriterConfig ic = new IndexWriterConfig(Version.LUCENE_4_10_3,analyzer);
		// 建立内存索引对象
	...
	private void search(Analyzer analyzer, Directory directory, String queryStr)
		...
		QueryParser tq = new QueryParser(Version.LUCENE_4_10_3, "text",ansjHeightAnalyzer);
