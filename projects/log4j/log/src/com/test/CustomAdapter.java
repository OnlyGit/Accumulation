...
*/
public class CustomAdapter extends FileAppender {
     ...
     */
    public CustomAdapter(Layout layout, String filename,
        ...
        FilenameFilter filter = new FilenameFilter() {
            ...
            public boolean accept(File dir, String name) {
                ...
                if (perentDirectory != null)
                {
                    ...
                    b = name.startsWith(localFile);
                    return name.startsWith(localFile);
                }
                b = name.startsWith(fileName);
                return b;
            }
        };
        File file = new File(fileName);
...
class RollingCalendar extends GregorianCalendar {
    ...
    int type = CustomAdapter.TOP_OF_TROUBLE;
    ...
    public Date getNextCheckDate(Date now) {
        ...
        switch (type) {
            case CustomAdapter.TOP_OF_MINUTE:
                this.set(Calendar.SECOND, 0);
                this.set(Calendar.MILLISECOND, 0);
                this.add(Calendar.MINUTE, 1);
                break;
            case CustomAdapter.TOP_OF_HOUR:
                this.set(Calendar.MINUTE, 0);
                this.set(Calendar.SECOND, 0);
                this.set(Calendar.MILLISECOND, 0);
                this.add(Calendar.HOUR_OF_DAY, 1);
                break;
            case CustomAdapter.HALF_DAY:
                this.set(Calendar.MINUTE, 0);
                this.set(Calendar.SECOND, 0);
                this.set(Calendar.MILLISECOND, 0);
            ...
            case CustomAdapter.TOP_OF_DAY:
                ...
                break;
            case CustomAdapter.TOP_OF_WEEK:
                ...
                break;
            case CustomAdapter.TOP_OF_MONTH:
